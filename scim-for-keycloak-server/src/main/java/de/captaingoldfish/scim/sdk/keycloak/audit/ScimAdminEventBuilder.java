...
public class ScimAdminEventBuilder {
  ...
  private AdminAuth getAnonymousAdminAuth() {
    ...
    UserModel user =
        new UserAdapter(
            keycloakSession, keycloakSession.getContext().getRealm(), entityManager, userEntity);
    ...
    ClientModel client =
        new ClientAdapter(
            keycloakSession.getContext().getRealm(), entityManager, keycloakSession, clientEntity);
