...
public class ScimEndpointProviderFactory implements RealmResourceProviderFactory {
  ...
  /**
   * keycloak calls this method to create an instance of {@link ScimEndpointProvider} with each
   * incoming request
   *
   * @param session the {@link KeycloakSession} object holds the authentication details about the
   *     current user and the realm the user is currently using
