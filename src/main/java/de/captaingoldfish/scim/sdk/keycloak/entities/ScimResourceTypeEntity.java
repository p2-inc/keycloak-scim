...
@NamedQueries({
  @NamedQuery(
      ...
      query =
          "SELECT rt FROM ScimResourceTypeEntity rt WHERE "
              + "rt.realmId = :realmId and rt.name = :name"),
  @NamedQuery(
      name = "removeScimResourceTypes",
      query = "DELETE FROM ScimResourceTypeEntity rt WHERE " + "rt.realmId = :realmId")
})
public class ScimResourceTypeEntity {
  ...
  /**
   * activates the automatic calculation of eTags for this resource type if no version attribute has
   * been set
   */
  ...
  /**
   * the roles to access the create endpoint. Nullifies the values of {@link #endpointRoles} if at
   * least one value is present
   */
  // @formatter:off
  @OneToMany
  @JoinTable(
      name = "SCIM_ENDPOINT_CREATE_ROLES",
      joinColumns = {@JoinColumn(name = "SCIM_RESOURCE_TYPE_ID")},
      inverseJoinColumns = {@JoinColumn(name = "ROLE_ID")})
  // @formatter:on
  ...
  /**
   * the roles to access the get/list endpoint. Nullifies the values of {@link #endpointRoles} if at
   * least one value is present
   */
  // @formatter:off
  @OneToMany
  @JoinTable(
      name = "SCIM_ENDPOINT_GET_ROLES",
      joinColumns = {@JoinColumn(name = "SCIM_RESOURCE_TYPE_ID")},
      inverseJoinColumns = {@JoinColumn(name = "ROLE_ID")})
  // @formatter:on
  ...
  /**
   * the roles to access the update/patch endpoint. Nullifies the values of {@link #endpointRoles}
   * if at least one value is present
   */
  // @formatter:off
  @OneToMany
  @JoinTable(
      name = "SCIM_ENDPOINT_UPDATE_ROLES",
      joinColumns = {@JoinColumn(name = "SCIM_RESOURCE_TYPE_ID")},
      inverseJoinColumns = {@JoinColumn(name = "ROLE_ID")})
  // @formatter:on
  ...
  /**
   * the roles to access the delete endpoint. Nullifies the values of {@link #endpointRoles} if at
   * least one value is present
   */
  // @formatter:off
  @OneToMany
  @JoinTable(
      name = "SCIM_ENDPOINT_DELETE_ROLES",
      joinColumns = {@JoinColumn(name = "SCIM_RESOURCE_TYPE_ID")},
      inverseJoinColumns = {@JoinColumn(name = "ROLE_ID")})
  // @formatter:on
